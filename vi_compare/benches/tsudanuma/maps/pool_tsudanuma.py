...
def main():
    ...
    full_res = 0.05
    # origin must match assets/map_tsudanuma.yaml (0,0,0): the 本家 goal disk
    # (setStateValues) is computed as cell_center = ix*res + map_origin, so the
    # origin has to agree with bench_map (origin 0,0) for the same goal cells.
    origin = (0.0, 0.0, 0.0)
