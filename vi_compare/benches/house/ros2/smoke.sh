#!/usr/bin/env bash
# vi_compare/benches/house/ros2/smoke.sh — end-to-end runtime smoke test for vi_node.
#
...
#   bash /workspace/vi_compare/benches/house/ros2/smoke.sh
#
# Or from host:
#   docker run --rm -v "$(pwd)":/workspace -w /workspace \
#     vi_ros2_dev:humble bash /workspace/vi_compare/benches/house/ros2/smoke.sh
set -euo pipefail
