"""Value Iteration FPGA overlay — tile-based kernel for PYNQ on Ultra96-V2.
...
ADDR_CU_ID         = 0x54  # 0=even tiles, 1=odd tiles (checkerboard)
ADDR_MAX_DELTA     = 0x5C
...
class VIOverlay:
    ...
    def run(
        ...
        Both CUs run simultaneously each sweep with checkerboard scheduling:
        CU0 processes tiles where (tx+ty)%2==0, CU1 where (tx+ty)%2==1.
        ...
        # CU0=even checkerboard, CU1=odd checkerboard
